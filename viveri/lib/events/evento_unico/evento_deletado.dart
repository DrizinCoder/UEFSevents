...
class EventoDeletado extends StatelessWidget {
  final Map<String, dynamic> userData;
  final String accessToken;
  const EventoDeletado({super.key, required this.userData, required this.accessToken});
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            const Icon(Icons.delete_outline_outlined, size: 100, color:Color.fromARGB(255, 155, 13, 13) ),
