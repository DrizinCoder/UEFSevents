...
class EventoCriado extends StatefulWidget {
  ...
  const EventoCriado({super.key, required this.accessToken, required this.userData});


  @override
  State<EventoCriado> createState() => _EventoCriado();
}


class _EventoCriado extends State<EventoCriado> {
  ...
  Widget build(BuildContext context) {
    ...
    bool _isFavorito = false;
    //final String currentUserId = await _getCurrentUserId(); // Sua lógica aqui 
                        ...
                        child: Tooltip(
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(builder: (_) => CreateEvent(accessToken: widget.accessToken, userData: widget.userData,)),
                              );
                            },
                          ),
                        ),
                      ),
                      SizedBox(width: width * 0.05), // Espaçamento à esquerda
                      Positioned(
                        top: 30,
                        right: 10,
                        child: Tooltip(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Column(
                                  children: [
                                    ...
                                    SizedBox(height: 40),
                                    _buildInfoRow(Icons.calendar_today, evento.start_date.toString().substring(0, 10)),
                                    SizedBox(width: 20),
                            ...
                            _buildInfoSection('Tipo do Evento:', "festa",Icons.event_available,),
                                  ...
                                  Tooltip(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: ()
                                      {
                                        ...
                                        // (
                                        //   context,
                                        //   MaterialPageRoute(builder: (_) => FaqTela(currentUser:currentUserId, , isDono:isUserOwner)),
                                        // );
                                  ...
                                  Tooltip(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () async {
                                        ...
                                        await store.deleteEventById(eventoId);
                                        Navigator.pushReplacement(
                                          context,
                                          MaterialPageRoute(builder: (_) => EventoDeletado(userData:widget.userData, accessToken: widget.accessToken,)),
                                        );
                                      },
