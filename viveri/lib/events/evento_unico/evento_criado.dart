...
// class EventoCriado extends StatefulWidget {
//   final int eventId; // Recebe o ID do evento como parâmetro

//   const EventoCriado({super.key, required this.eventId});
...
//       final event = await store.repository.getEventById(widget.eventId);
//       setState(() {
//         _currentEvent = event;
//       });
      
//       // Carrega os dados do espaço associado
//       if (event != null) {
//         _loadSpace(event.space);
//       }
//     } catch (e) {
...
//                                 _buildInfoRow(
//                                   Icons.location_on, 
//                                   _currentSpace?.name ?? 'Carregando...'
//                                 ),
//                                 SizedBox(height: 40),
//                                 _buildInfoRow(
//                                   Icons.calendar_today, 
//                                   _currentEvent!.start_date
//                                 ),
//                                 SizedBox(width: 20),
//                                 _buildInfoRow(
//                                   Icons.access_time, 
//                                   _currentEvent!.start_time
//                                 ),
//                               ],
//                             ),
//                           ],
...
//                                 color: Color(0xFF586C61), size: 30),
//                             ),
//                             Expanded(
//                               child: Text(
...
//                                     color: Color.fromRGBO(88, 108, 97, 1), size: 30),
//                                 ),
//                                 _buildSectionTitle('Onde vai rolar?'),
//                               ],
//                             ),
...
//                                   padding: EdgeInsets.only(left: 10),
//                                   decoration: BoxDecoration(
//                                     color: Color.fromRGBO(152, 175, 162, 1),
//                                     shape: BoxShape.rectangle,
//                                   ),
//                                 ),
//                               ],
...
//                           child: Stack(
//                             children: [
//                               // ... (código dos círculos permanece igual)
//                             ],
//                           ),
//                         ),
...
//                             mainAxisAlignment: MainAxisAlignment.center, 
//                             children: [
//                               Icon(Icons.question_answer, color:  Color(0xFF586C61), size: 30),
//                               SizedBox(width: 8),
//                               ElevatedButton(
//                                 onPressed: () {},
//                                 style: ElevatedButton.styleFrom(
...
//                               Icon(Icons.warning_amber, color: Colors.amber[300], size: 30),
//                               SizedBox(width: 8),
//                               ElevatedButton(
//                                 onPressed: () {},
//                                 style: ElevatedButton.styleFrom(
