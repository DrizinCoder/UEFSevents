...
//   @override
//   State<EventoUnicoCadastro> createState() => _EventoUnicoCadastro();
// }


// class _EventoUnicoCadastro extends State<EventoUnicoCadastro> {
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    _buildInfoRow(Icons.location_on, event.space. ?? 'Local desconhecido'),
                                    const SizedBox(height: 10),
                          ...
                          _buildSectionTitle('Para mais informações'),
                          const SizedBox(height: 20),
                          _buildInfoRow(Icons.phone, event.space.phone ?? 'Telefone indisponível'),
                          ...
                          Center(
                            child: Column(
                              children: [
                                ...
                                Text(
                                  'Organizador: ${event.space.name ?? 'Desconhecido'}',
