# Generated by Django 5.2 on 2025-07-03 01:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ans_to_ans_fk_answer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subanswers', to='FAQ.answers')),
            ],
        ),
        migrations.CreateModel(
            name='Complaints',
